...
class Payment extends StatelessWidget {
  ...
  return new WebviewScaffold(
      ...
      url: 'https://3dsec.sberbank.ru/payment/docsite/payform-1.html?token=YRF3C5RFICWISEWFR6GJ&def=%7B"amount":"'+struct['Sum']+'"%7D&def=%7B%22description%22:"'+struct['Order']+'"%7D&ask=email',//new Uri.dataFromString(payurl,mimeType: 'text/html').toString(),
      withZoom: false,
      allowFileURLs: true,
